    ...
    const gameData = {
        ...
        phase3: {
            ...
            quiz: [
                ...
                { question: "O que fazer quando perceber um vazamento?", options: ["Consertar o mais rápido possível", "Deixar para depois", "Colocar um balde embaixo", "Ignorar"], answer: 1, feedback: "Cada gota conta! Um pequeno vazamento pode desperdiçar até 46 litros por dia. Observe, conserte e economize!" }
            ]
        }
    };
